...
export class Covid19ReportComponent implements OnInit {
  ...
  public endMonth: Date = dayjs().endOf('month').toDate();
  public startMonth: Date = dayjs().endOf('month').toDate();
  ...
  public onIndicatorSelect($event: any) {
    this.router.navigate(['patient-list'], {
      ...
      queryParams: {
        ...
        endingMonth: dayjs(this.params.endingMonth).format('YYYY-MM-DD'),
  ...
  public setParams() {
    this.params = {
      ...
      endingMonth: dayjs(this.endMonth).format('YYYY-MM-DD')
    };
  }
