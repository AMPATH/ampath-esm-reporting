...
export class DataEntryStatisticsFiltersComponent
  ...
  public provider = '';
  public selectedStartDate: any = dayjs().format();
  public selectedEndDate: any = dayjs(this.selectedStartDate)
    .add(6, 'days')
    .format();
  public subType = '';
  public groupBy: any = [
  ...
  public selectedStartMonth = dayjs().format('YYYY-MM');
  ...
  public getSelectedStartDate($event) {
    ...
    this.selectedEndDate = dayjs(selectedDate).add(6, 'days').toISOString();
    this.selectedStartDate = dayjs(selectedDate).toISOString();
  }
  public getSelectedEndDate($event) {
    const selectedDate = $event;
    this.selectedEndDate = dayjs(selectedDate).toISOString();
  }
  public getSelectedStartMonth($event) {
    const selectedDate = dayjs($event).format('YYYY-MM-DD');
    this.selectedStartDate = dayjs(selectedDate)
      .startOf('month')
      .toISOString();
    this.selectedEndDate = dayjs(this.selectedStartDate)
      .add(12, 'months')
      .toISOString();
  }
  ...
  public toggleViewParams(view) {
    ...
    switch (view) {
      case 'view1':
        this.selectedStartDate = dayjs().format();
        this.selectedEndDate = dayjs(this.selectedStartDate)
          .add(6, 'days')
          .format();
        ...
        break;
      case 'view2':
        this.selectedStartDate = dayjs().startOf('month').toISOString();
        this.selectedEndDate = dayjs(this.selectedStartDate)
          .add(12, 'months')
          .format();
  ...
  public setQueryParams() {
    this.params = {
      ...
      startDate: dayjs(this.selectedStartDate).format(),
      endDate: dayjs(this.selectedEndDate).format(),
  ...
  public previousWeek() {
    this.selectedStartDate = dayjs(this.selectedStartDate)
      .subtract(7, 'days')
      .format();
    this.selectedEndDate = dayjs(this.selectedStartDate)
      .add(6, 'days')
