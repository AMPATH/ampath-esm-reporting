      ...
      default:
        ...
        if (data.data.location_name === 'Totals') {
          ...
          if (period === 'daily') {
            ...
            endDate = dayjs(data.data.encounter_datetime, 'DD-MM-YYYY').format(
              'YYYY-MM-DD'
            );
          } else if (period === 'monthly') {
            startDate = dayjs(data.data.encounter_datetime, 'MM-YYYY')
              .startOf('month')
              .format('YYYY-MM-DD');
            endDate = dayjs(data.data.encounter_datetime, 'MM-YYYY')
              .endOf('month')
              .format('YYYY-MM-DD');
          }
