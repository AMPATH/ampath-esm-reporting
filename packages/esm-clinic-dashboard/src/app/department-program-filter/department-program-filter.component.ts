...
export class DepartmentProgramFilterComponent
  ...
  public selectedStartDate: string = dayjs()
    .startOf('month')
    .format('YYYY-MM-DD');
  public selectedEndDate: string = dayjs().endOf('month').format('YYYY-MM-DD');
  public params: any = {
  ...
  public setParams() {
    const startDate = dayjs(this.selectedStartDate).format('YYYY-MM-DD');
    const endDate = dayjs(this.selectedEndDate).format('YYYY-MM-DD');
    const programUuids = [];
  ...
  public validateFilterSelected() {
    ...
    if (this.selectedEndDate === null) {
      this.selectedEndDate = dayjs().endOf('month').format('YYYY-MM-DD');
    }
    return true;
  }
  ...
  public initializeParams() {
    this.selectedStartDate = dayjs().startOf('month').format('YYYY-MM-DD');
    this.selectedEndDate = dayjs().endOf('month').format('YYYY-MM-DD');
