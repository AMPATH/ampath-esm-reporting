...
export class SurgeReportBaseComponent implements OnInit {
  ...
  constructor(
    ...
    this.route.queryParams.subscribe((data) => {
      ...
      data._date === undefined
        ? (this.startDate = dayjs(new Date()).format('MM-DD-YYYY'))
        : (this.startDate = dayjs(data._date).format('MM-DD-YYYY'));
      ...
      case 'daily':
        this.router.navigate(['surge-report-patientlist'], {
          ...
          queryParams: {
            ...
            _date: dayjs(this.startDate).format('YYYY-MM-DD'),
  ...
  public onStartDateChange(value) {
    this.startDate = dayjs(value).format('MM-DD-YYYY');
  }
        ...
        res.result.forEach((element: any) => {
          this.calendarWeeks.push({
            ...
            name:
              ...
              ' From ' +
              dayjs(element.start_date).format('ddd-DD MMM-YYYY') +
              ' To ' +
              dayjs(element.end_date).format('ddd-DD MMM-YYYY')
          });
          if (
