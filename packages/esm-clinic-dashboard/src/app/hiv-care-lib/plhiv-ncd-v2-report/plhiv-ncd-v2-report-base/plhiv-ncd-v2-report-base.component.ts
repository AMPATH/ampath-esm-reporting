...
export class PlhivNcdV2ReportBaseComponent implements OnInit {
  ...
  public _startDate: Date = dayjs().subtract(1, 'M').endOf('month').toDate();
  ...
  public _endDate: Date = dayjs().subtract(1, 'M').endOf('month').toDate();
  ...
  public handleChange($event: any) {
    ...
    this._month = dayjs().subtract(1, 'M').endOf('month').format('YYYY-MM-DD');
    this._startDate = dayjs().subtract(1, 'M').endOf('month').toDate();
    this._endDate = dayjs().subtract(1, 'M').endOf('month').toDate();
  }
  ...
  public onMonthChange(value): any {
    ...
    this._endDate = new Date(dayjs(value).endOf('month').format('YYYY-MM-DD'));
  ...
  public storeParamsInUrl(param) {
    this.params = {
      locationUuids: param,
      month: dayjs(this._month).endOf('month').format('YYYY-MM-DD'),
      startDate: dayjs(this._startDate).format('YYYY-MM-DD'),
      endDate: dayjs(this._month).endOf('month').format('YYYY-MM-DD'),
