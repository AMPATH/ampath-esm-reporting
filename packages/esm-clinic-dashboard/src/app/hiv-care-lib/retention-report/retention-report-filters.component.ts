...
export class RetentionReportFiltersComponent implements OnInit {
  ...
  @Input() public startDate = dayjs().startOf('week').toISOString();
  @Input() public endDate = dayjs().endOf('week').toISOString();
  ...
  public setParamsFromUrl() {
    if (this.params.startDate && this.params.endDate) {
      this.startDate = dayjs(this.params.startDate).toISOString();
      this.endDate = dayjs(this.params.endDate).toISOString();
