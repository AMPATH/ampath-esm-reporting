...
export class Moh731FiltersComponent implements OnInit {
  ...
  public get startDateString(): string {
    return this.startDate ? dayjs(this.startDate).format('YYYY-MM-DD') : null;
  }
  ...
  public get endDateString(): string {
    return this.endDate ? dayjs(this.endDate).format('YYYY-MM-DD') : null;
  }
  ...
  public get monthString(): string {
    return this.month ? dayjs(this.month).format('YYYY-MM') : null;
  }
  ...
  public set month(v: Date) {
    this._month = v;
    this.startDate = dayjs(this._month).startOf('month').toDate();
    this.endDate = dayjs(this._month).endOf('month').toDate();
  }
