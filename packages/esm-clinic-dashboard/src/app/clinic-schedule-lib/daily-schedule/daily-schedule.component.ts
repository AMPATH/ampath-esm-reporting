...
export class DailyScheduleBaseComponent implements OnInit, OnDestroy {
  ...
  public selectedDate = dayjs().format('MMM  D , YYYY ');
  public viewDate = '';
  public changeDate;
  ...
  public getSelectedDate(date) {
    const m = dayjs(this.selectedDate).format('yyyy-MM-dd');
    this.selectedDate = dayjs(date).format('MMM  D , YYYY ');
  ...
  public filterSelected($event) {
    ...
    this.selectedDate = dayjs($event.startDate).format('MMM  D , YYYY ');
    this.changeDate = new Date(this.selectedDate);
  }
